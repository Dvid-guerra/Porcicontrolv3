...
// For PDF elements, maybe we shouldn't change them because they are for print. Let's revert grid-cols-2 changes inside print wrappers if they exist.
...
content = content.replace(/className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-2xl mx-auto"/g, 'className="grid grid-cols-2 gap-12 max-w-2xl mx-auto"'); // Used in PDF Note
